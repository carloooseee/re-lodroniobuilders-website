...
<h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-primary">
                        A firm built on <br /><em className="font-serif italic">purpose</em><br /> and <em className="font-serif italic">craft.</em>
</h1>
</div>
...
<h2 className="font-headline-md text-headline-md text-primary mb-4 leading-tight">
                    “For every house is built by someone, but <em className="font-serif italic">God</em> is the builder of everything”
                </h2>
...
<h2 className="font-headline-lg text-headline-lg text-primary mb-2">Ar. Roco E. <em className="font-serif italic">Lodronio</em></h2>
...
<span className="font-headline-sm text-headline-sm text-on-surface-variant italic block mb-6">01</span>
<h3 className="font-body-lg text-body-lg text-primary mb-3">Honesty</h3>
<p className="font-body-md text-body-md text-on-surface-variant">Clear, truthful communication from proposal to turnover.</p>
</div>

<div className="bg-surface-container-low p-8 border border-outline-variant/10 hover:bg-surface-container transition-colors duration-300">
<span className="font-headline-sm text-headline-sm text-on-surface-variant italic block mb-6">02</span>
<h3 className="font-body-lg text-body-lg text-primary mb-3">Openness</h3>
<p className="font-body-md text-body-md text-on-surface-variant">Transparent processes, no hidden surprises.</p>
</div>

<div className="bg-surface-container-low p-8 border border-outline-variant/10 hover:bg-surface-container transition-colors duration-300">
<span className="font-headline-sm text-headline-sm text-on-surface-variant italic block mb-6">03</span>
<h3 className="font-body-lg text-body-lg text-primary mb-3">Professionalism</h3>
<p className="font-body-md text-body-md text-on-surface-variant">Quality craftsmanship, every time.</p>
</div>

<div className="bg-surface-container-low p-8 border border-outline-variant/10 hover:bg-surface-container transition-colors duration-300">
<span className="font-headline-sm text-headline-sm text-on-surface-variant italic block mb-6">04</span>
<h3 className="font-body-lg text-body-lg text-primary mb-3">Enthusiasm</h3>
<p className="font-body-md text-body-md text-on-surface-variant">Genuine passion for every build, big or small.</p>
</div>

<div className="bg-surface-container-low p-8 border border-outline-variant/10 hover:bg-surface-container transition-colors duration-300">
<span className="font-headline-sm text-headline-sm text-on-surface-variant italic block mb-6">05</span>
<h3 className="font-body-lg text-body-lg text-primary mb-3">Problem-solving</h3>
<p className="font-body-md text-body-md text-on-surface-variant">Practical solutions when challenges arise.</p>
</div>

<div className="bg-surface-container-low p-8 border border-outline-variant/10 hover:bg-surface-container transition-colors duration-300">
<span className="font-headline-sm text-headline-sm text-on-surface-variant italic block mb-6">06</span>
<h3 className="font-body-lg text-body-lg text-primary mb-3">Organization</h3>
...
<span className="font-headline-sm text-headline-sm text-on-surface-variant italic block mb-6">07</span>
<h3 className="font-body-lg text-body-lg text-primary mb-3">Project time management</h3>
...
<ul className="flex flex-wrap justify-center gap-6 font-label-caps text-label-caps uppercase">
<li><Link className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary dark:hover:text-on-primary transition-colors duration-300" to="/">Home</Link></li>
<li><Link className="text-primary dark:text-on-primary underline cursor-default" to="/about">About Us</Link></li>
<li><Link className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary dark:hover:text-on-primary transition-colors duration-300" to="/contact">Contact</Link></li>
<li><Link className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary dark:hover:text-on-primary transition-colors duration-300" to="/">Policy</Link></li>
</ul>
<div className="font-label-caps text-label-caps uppercase text-on-surface-variant text-[10px]">
