...
<header className="relative w-full h-[1024px] min-h-[600px] flex items-center justify-start overflow-hidden">
...
<div className="mt-section-gap flex items-end justify-between border-b border-on-primary/30 pb-4">
...
<main className="bg-surface relative z-20 pb-section-gap">
...
<div className="md:col-span-6 flex flex-col gap-6 mt-16 md:mt-24">
...
<div className="md:col-span-6 flex flex-col gap-6 mt-16 md:mt-0 justify-end">
...
<section className="mt-section-gap bg-surface-container-low pt-section-gap pb-section-gap px-margin-mobile md:px-margin-desktop" style={{ backgroundColor: 'rgb(29, 29, 29)' }}>
...
<footer className="bg-surface dark:bg-surface border-t border-outline-variant/20 py-section-gap px-margin-mobile md:px-margin-desktop w-full bottom-0">
<div className="max-w-container-max mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
<div className="font-label-caps text-label-caps text-on-surface-variant dark:text-on-surface-variant tracking-widest uppercase">
                © 2024 RE Lodronio Builders Inc.
            </div>
<div className="flex flex-wrap justify-center gap-8 font-body-md text-body-md">
<Link className="text-primary dark:text-on-primary underline cursor-default transition-colors duration-300" to="/">Home</Link>
<Link className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary dark:hover:text-on-primary transition-colors duration-300 cursor-default" to="/about">About Us</Link>
<Link className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary dark:hover:text-on-primary transition-colors duration-300 cursor-default" to="/contact">Contact</Link>
<Link className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary dark:hover:text-on-primary transition-colors duration-300 cursor-default" to="/">Policy</Link>
</div>
<div className="font-label-caps text-label-caps text-on-surface-variant dark:text-on-surface-variant tracking-widest uppercase text-right">
